...
<div class="nk-block">
        ...
        <div class="col-md-6">
            ...
            <div class="row gy-1">
                ...
                <div class="col-12">
                    ...
                    @if ($tnx->type == dTType::REFERRAL && (data_get($tnx, 'meta.referral.action') == dTType::DEPOSIT || data_get($tnx, 'meta.referral.action') == dTType::INVESTMENT))
                    <span class="small text-soft nk-tooltip" title="{{ ((data_get($tnx, 'meta.referral.action') == dTType::DEPOSIT) ? __('Deposit') : __('Investment')) . ': ' . money(data_get($tnx, 'meta.referral.tnx_amount'), base_currency(), ['dp' => 'calc']) }}"><em class="icon ni ni-info-fill"></em></span>
                    @endif
                </div>
            </div>
        </div>
    ...
    <div class="row gy-2">
        ...
        @if(data_get($tnx, 'meta.referral.investment'))
        <div class="col-lg-6">
            <span class="sub-text">{{ __('Investment ID') }}</span>
            <span class="caption-text text-break">{{ data_get($tnx, 'meta.referral.investment', '~') }}</span>
        </div>
        @endif
