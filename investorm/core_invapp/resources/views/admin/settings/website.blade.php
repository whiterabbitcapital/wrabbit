                ...
                <form action="{{ route('admin.save.app.settings') }}" class="form-settings" method="POST">
                    ...
                    <div class="form-sets gy-3 wide-md">
                        ...
                        <div class="row g-3 align-center">
                            <div class="col-lg-5">
                                <div class="form-group">
                                    <label class="form-label">{{ __('Main Website - User Dashboard') }}</label>
                                    <span class="form-note">{{ __('Alternative URL which apply into user dashboard.') }}</span>
                                </div>
                            </div>
                            <div class="col-lg-7">
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        <input type="text" class="form-control" name="main_website_ud" value="{{ sys_settings('main_website_ud') }}">
                                    </div>
                                    <div class="form-note">{{ __('If blank, it will be same as main website.') }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
